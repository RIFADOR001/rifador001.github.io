...
function convertColor(color) {
    if (color.length === 3) return RGBToHex(color);
    else if (color.length === 7) return hexToRGB(color);
    else return "The input is not valid";
}
...
//# sourceMappingURL=index.0dfb4d73.js.map
